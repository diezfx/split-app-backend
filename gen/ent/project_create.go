...
func (pc *ProjectCreate) SetMembers(s []string) *ProjectCreate {
	pc.mutation.SetMembers(s)
	return pc
}
...
func (pc *ProjectCreate) AddTransactionIDs(ids ...uuid.UUID) *ProjectCreate {
	pc.mutation.AddTransactionIDs(ids...)
	return pc
}

// AddTransactions adds the "transactions" edges to the Transaction entity.
func (pc *ProjectCreate) AddTransactions(t ...*Transaction) *ProjectCreate {
...
func (pc *ProjectCreate) check() error {
	...
	if _, ok := pc.mutation.Members(); !ok {
		return &ValidationError{Name: "members", err: errors.New(`ent: missing required field "Project.members"`)}
	}
	return nil
}
...
func (pc *ProjectCreate) createSpec() (*Project, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.Members(); ok {
