...
import (
	...
	"github.com/diezfx/split-app-backend/gen/ent/migrate"
...
// QueryTransactions queries the transactions edge of a Project.
func (c *ProjectClient) QueryTransactions(pr *Project) *TransactionQuery {
...
// QueryProject queries the project edge of a Transaction.
func (c *TransactionClient) QueryProject(t *Transaction) *ProjectQuery {
...
type (
	hooks struct {
		Project, Transaction []ent.Hook
	}
	inters struct {
		Project, Transaction []ent.Interceptor
	}
)
